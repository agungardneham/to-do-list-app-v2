...
mongoose.connect("mongodb+srv://" + process.env.ATLAS_ID + ":" + process.env.ATLAS_PASSWORD + "@cluster0.5mnvhch.mongodb.net/todolistDB", {useNewUrlParser: true, useUnifiedTopology: true});
